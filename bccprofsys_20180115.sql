...
INSERT INTO `department` VALUES (1,'2018-01-03 22:07:27','BSIS','bsis',0),(2,'2018-01-03 22:08:18','TED','ted',0),(6,'2018-01-03 22:29:28','BSIT','bsit',0),(7,'2018-01-03 22:29:46','BSOA','bsoa',0);
...
INSERT INTO `user_roles` VALUES (1,'2018-01-06 21:40:53','Admin','admin',3),(2,'2018-01-02 04:11:25','Student','student',0),(3,'2018-01-06 21:41:13','Dept. Coordinator','dept_coordinator',2),(4,'2018-01-06 21:41:06','Teacher','teacher',1);
...
CREATE TABLE `users` (
  ...
  `record_id` varchar(255) NOT NULL COMMENT 'Student ID provided by registrar',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2018-01-15  6:39:11
